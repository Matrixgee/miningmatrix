    ...
    <div className="w-full py-20 bg-gradient-to-b from-[#0A0A0A] to-[#1A0B2E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          >
            Investor <span className="text-[#22A0B7]">Testimonials</span>
          </motion.h2>
          ...
          >
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="w-full flex-shrink-0 px-4">
                ...
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[#22A0B7]"></div>
                  <div className="relative h-full bg-gray-900 rounded-xl p-8">
                    <div className="flex flex-col items-center">
                      {/* Image with Rating */}
                      <div className="mb-8 relative">
                        <div className="w-20 h-20 rounded-full overflow-hidden ring-4 ring-[#22A0B7]/30 relative z-10">
                          <img
                            src={testimonial.img}
                        ...
                        <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-[#22A0B7] text-white px-4 py-1 rounded-full text-sm font-medium shadow-lg">
                      ...
                      <blockquote className="text-gray-300 text-lg text-center mb-8 leading-relaxed relative">
                        <span className="absolute -top-6 left-0 text-5xl text-[#22A0B7]/30">
                          "
                        </span>
                        {testimonial.testimony}
                        <span className="absolute -bottom-6 right-0 text-5xl text-[#22A0B7]/30">
                          "
                        </span>
                      </blockquote>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-[#22A0B7]">{testimonial.role}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
