...
const Faq = () => {
  ...
  const faqItems = [
    {
      question: "What is Mining Matrix Capital?",
      answer:
        "Mining Matrix Capital is a platform that allows you to buy, sell, and trade cryptocurrencies securely. It offers investment plans with attractive returns.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, Mining Matrix Capital Finance prioritizes security. We use advanced encryption and security protocols to protect your investments and personal information.",
    },
    {
      question: "How can I contact customer support?",
      answer:
        "You can contact our customer support team via email at miningmatrixcapital.com or through our live chat feature available on our website.",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold text-[#22A0B7]"
          >
          ...
          {faqItems.map((item, index) => (
            <motion.div
              ...
              className={`border border-gray-800 rounded-xl transition-all duration-300 ${
                selected === index
                  ? "bg-gray-900/80 border-[#22A0B7]"
                  : "bg-gray-800/60 hover:border-[#22A0B7]/70"
              }`}
            >
              <button
              ...
              >
                <div className="flex items-center gap-3">
                  <FaQuestionCircle className="text-[#22A0B7]" />
                  <h3 className="text-lg font-medium group-hover:text-[#22A0B7]">
                    {item.question}
                  </h3>
                </div>
                <motion.span
