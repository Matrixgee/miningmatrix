...
const Plans = () => {
  ...
  return (
    <div className="w-full scrollbar-thin overflow-y-scroll h-full bg-blue-50">
            ...
            <div className="relative bg-gradient-to-br from-white to-white backdrop-blur-lg border border-white/20 rounded-2xl p-12 text-center">
              ...
              <div className="relative ">
                ...
                <button
                  ...
                  className="group flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-500 hover:to-purple-500 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 mx-auto"
                >
