...
const Withdraw = () => {
  ...
  return (
    <div className="w-full scrollbar-thin overflow-y-scroll h-full bg-blue-50 text-white relative">
      ...
      {/* Scrollable content */}
      <div className="relative overflow-y-auto h-full  custom-scrollbar-hide">
        <div className="p-6 pb-20">
          ...
          <div className="mb-8 py-2 gap-5">
            <div className="w-full h-12 bg-white shadow-md mb-6 rounded-xl flex  items-center px-4 sm:px-2 gap-4">
              <div
                className="flex items-center gap-2  text-blue-600 font-semibold cursor-pointer transition hover:text-blue-800"
                onClick={handleBack}
              >
                <MdArrowBack size={20} />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-900 border border-blue-500/20 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 bg-slate-900 border border-blue-500/20 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/20 transition-all resize-none"
                    />
                  </div>
                </div>
              </div>
