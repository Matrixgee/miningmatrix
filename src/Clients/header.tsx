import TradingViewWidgettwo from "../Component/tradingviewone";
import { BsSend } from "react-icons/bs";
import { GoDownload } from "react-icons/go";
import { useNavigate } from "react-router-dom";
import logo from "../assets/MiningmatrixlogoIcon.png";
...
const Header = () => {
  ...
  return (
    <div className="w-full h-full  flex justify-around flex-col items-center max-md:hidden">
      ...
      <div className="w-full h-[60%] bg-gradient-to-b from-[#0A0A0A] to-[#0c011a] flex justify-between   items-center">
        <div
          className="w-[10%]   h-[90%] flex justify-center items-center px-2 cursor-pointer"
          onClick={() => navigate("/")}
        >
          <img src={logo} alt="" className=" w-[170%]  h-[100%] object-cover" />
        </div>
