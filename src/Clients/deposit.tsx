...
const Deposit = () => {
  ...
  return (
    <div className="w-full scrollbar-thin overflow-y-scroll h-full bg-blue-50 text-white relative">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              {showProof && (
                ...
                >
                  <ArrowLeft className="w-5 h-5 text-[#22A0B7]" />
                </button>
              )}
              <div className="mb-8">
                {/* Top Bar */}
                <div className="w-full h-12 bg-white shadow-md rounded-xl flex  items-center px-4 sm:px-2 gap-4">
                  <div
                    className="flex items-center gap-2 text-[#22A0B7] font-semibold cursor-pointer transition hover:text-purple-800"
                    onClick={handleBack}
                  >
                    <MdArrowBack size={20} />
                ...
                <div className="mt-6">
                  <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 flex items-center gap-2 mb-2">
                    {/* Optional icon: <Wallet className="w-7 h-7 text-blue-500" /> */}
          ...
          {!showProof ? (
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                {/* Payment Methods */}
                <div className="bg-slate-900 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                      ...
                      <div
                        ...
                        className={`p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                          selectedMethod === method.id
                            ...
                            : "border-blue-500/20 bg-slate-900 hover:border-blue-400/30"
                        }`}
                      >
                        ...
                        <div className="space-y-1 text-sm">
                          <p className="text-slate-300">
                            Fee:{" "}
                            <span className="text-blue-400">{method.fee}</span>
                          </p>
                          <p className="text-slate-300">
                            Min:{" "}
                ...
                <div className="bg-slate-900 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="10"
                      className="w-full pl-10 pr-4 py-4 bg-slate-900 border border-blue-500/20 rounded-lg text-white placeholder-slate-400 focus:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all"
                    />
                  </div>
                ...
                <div className="bg-slate-900 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="bg-slate-900 border border-blue-500/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1 text-blue-400 hover:text-blue-300 transition-colors px-2 py-1 rounded hover:bg-blue-500/10"
                      >
                        {copied ? (
                    ...
                    <div className="break-all text-white font-mono text-sm bg-slate-900 p-3 rounded border border-blue-500/10 hover:bg-slate-900 transition-colors">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-900 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  {!proof ? (
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-slate-900 rounded-lg border border-blue-500/20">
                ...
                <div className="bg-slate-900 backdrop-blur-sm border border-blue-500/20 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-900 rounded-lg border border-blue-500/10">
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-500 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                    >
                      {isLoading ? (
                        <>
